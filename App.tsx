...
const AppContent = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-black selection:bg-black selection:text-white md:cursor-none cursor-auto">
      {/* Custom Metallic Fluid Cursor - Desktop Only */}
      <FluidCursor />
